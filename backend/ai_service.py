...
def build_prompt(
    ...
    lines.append("- Section 2 should explain the reasoning using 2 to 3 concise bullet points.")
    lines.append("- Section 3 should highlight the strongest implications or patterns using 1 to 2 concise bullet points.")
